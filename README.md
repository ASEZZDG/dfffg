...
pip install lolcat
git clone https://github.com/ASEZZDG/dfffg.git
cd qurxin
chmod +x *
sh install.sh
exit
...
```
apt update && upgrade -y && apt install git -y && pkg install mpv figlet python && pip install lolcat && git clone https://github.com/ASEZZDG/dfffg.git && cd qurxin && chmod +x * && ./install.sh
```
## screen shot
